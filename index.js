            ...
            button.textContent === "atividade 1"
              ? (function () {
                  ...
                  function mostrarResposta() {
                    ...
                    let mostra_inputs =
                      document.querySelector("#mostra_inputs");
                    if (mostra_inputs) {
              ...
              ? (function () {
                  ...
                  var botaoConfirmar =
                    document.getElementById("confirmarButton");
              ...
              ? (function () {
                  ...
                  let button_confirmar =
                    document.querySelector("#confirmar_button");
              ...
              ? (function () {
                  ...
                  button_atv4.addEventListener("click", function () {
                    ...
                    if (tam_content < tam_tela) {
                      ...
                      document.querySelector("#content").style.height =
                        tam_tela + "px";
                      document.querySelector("#resposta_div").style.height =
                        tam_tela + "px";
                      document.querySelector("#resposta_div").style.width =
                        "100%";
                    }
              ...
              ? (function () {
                  ...
                  button_atv7.addEventListener("click", function () {
                    ...
                    var editora =
                      document.querySelector("#input_editora").value;
              ...
              ? (function () {
                  ...
                  button_atv9.addEventListener("click", function () {
                    ...
                    var frasesCapitalizadas = guarda_texto.map(function (
                      frase
                    ) {
                      return frase
                        .split(" ")
              ...
              ? (function () {
                  ...
                  var div_resposta_api =
                    document.querySelector("#div_resposta_api");
                    ...
                    fetch(apiUrl)
                      ...
                      .then((dados_api) => {
                        if (div_resposta_api) {
                          ...
                          console.error(
                            "Elemento div_resposta_api não encontrado."
                          );
                        }
                      })
                      .catch((erro_api) => {
