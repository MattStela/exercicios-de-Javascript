...
//CONTENT
const content = document.querySelector("#content"); // Seleciona o elemento <content>
...
//Clicando em início
var inicio_link = document.querySelector("#inicio_link");;
inicio_link.addEventListener('click',function (){
  conteudoInicial()
})

//Clicando em exercícios
var exercicios_link = document.querySelector("#exercicios_link");
